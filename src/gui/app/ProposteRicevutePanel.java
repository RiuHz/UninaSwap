...
public class ProposteRicevutePanel extends JPanel {
    ...
    ProposteRicevutePanel(AppController controller) {
       this.controller = controller;
       
       createComponents(controller);
    }
    
    private void createComponents(AppController controller) {
    	JPanel pageHeader = createPageHeader();
    	
    	JScrollPane pannelloProposte = new JScrollPane(createPannelloProposte());
    	
    	setLayout(new BorderLayout());
    	add(pageHeader, BorderLayout.NORTH);
    	add(pannelloProposte, BorderLayout.CENTER);
    }
    
    private JPanel createPageHeader() {
    	JPanel pageHeader = new JPanel();
    	
    	JButton bottoneHome = new UnderlineButton("Torna alla home", black);
    	...
    	addToPageHeaderLayout(pageHeader, bottoneHome);
    ...
    private JPanel createPannelloProposte() {
    	...
    	for (PropostaRegaloDTO proposta: getProposteRegalo())
    		listaCard.add(new CardPropostaRegaloRicevuta(controller, proposta));
    	
    	for (PropostaVenditaDTO proposta: getProposteVendita())
    		listaCard.add(new CardPropostaVenditaRicevuta(controller, proposta));
    	
    	for (PropostaScambioDTO proposta: getProposteScambio())
    		listaCard.add(new CardPropostaScambioRicevuta(controller, proposta));
    ...
    protected void addToPageHeaderLayout(JPanel header, JComponent component) {
